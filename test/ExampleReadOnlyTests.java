...
public class ExampleReadOnlyTests {
  ...
  public void testingCoordinatesOfAHexagonBasedOn2DArraySquare() {
    ...
    HexShape topLeft = regularBoard.getCurrentHex(0, 3);
    HexShape topLeftRepresentation = new HexShape(-3, 0, null);
    Assert.assertNotEquals(topLeft.getColumn(), topLeftRepresentation.getColumn());

    HexShape middle = regularBoard.getCurrentHex(3, 3);
    HexShape middleRepresentation = new HexShape(0, 0, null);
    Assert.assertNotEquals(middle.getRow(), middleRepresentation.getRow());
    Assert.assertNotEquals(middle.getColumn(), middleRepresentation.getColumn());


    HexShape bottomLeft = regularBoard.getCurrentHex(6, 0);
    HexShape btmLeftRep = new HexShape(3, -3, null);
    Assert.assertNotEquals(bottomLeft.getRow(), btmLeftRep.getRow());
    Assert.assertNotEquals(bottomLeft.getColumn(), btmLeftRep.getColumn());

    HexShape topRightHex = regularBoard.getCurrentHex(0, 6);
    HexShape topRightRepresentation = new HexShape(-3, 3, null);
    Assert.assertNotEquals(topRightHex.getRow(), topRightRepresentation.getRow());
    Assert.assertNotEquals(topRightHex.getColumn(), topRightRepresentation.getColumn());

    HexShape rightMiddle = regularBoard.getCurrentHex(3, 4);
    HexShape rightMiddleRep = new HexShape(0, 1, null);
    Assert.assertNotEquals(rightMiddle.getRow(), rightMiddleRep.getRow());
    Assert.assertNotEquals(rightMiddle.getColumn(), rightMiddleRep.getColumn());
  }
  ...
  @Test
  public void testInitialSquareBoard() {
    TextualSquareController controller = new TextualSquareController(square);
    Assert.assertEquals(
            "- - - - - - - - \n" +
            "- - - - - - - - \n" +
            "- - - - - - - - \n" +
  ...
  public void testSquareBoard() {
    ...
    Assert.assertEquals(8, square.getBoardSize());
  }
   ...
   */
  @Test
  public void testBoardFullInitialState() {
   ...
   */
  @Test
  public void testBoardFullInitialStateSquare() {
    Assert.assertFalse(square.isBoardFull());
  }
  ...
  public void testCountSquare() {
    ...
    board.getCurrentHex(8 / 2, 8 / 2 + 1).setPlayerType(PlayerType.BLACK);
    board.getCurrentHex(8 / 2 + 1, 8 / 2).setPlayerType(PlayerType.WHITE);
    board.getCurrentHex(8 / 2, 8 / 2 - 1).setPlayerType(PlayerType.WHITE);
    board.getCurrentHex(8 / 2 + 1, 8 / 2 - 1).setPlayerType(PlayerType.BLACK);
    board.getCurrentHex(8 / 2 - 1, 8 / 2).setPlayerType(PlayerType.BLACK);
    board.getCurrentHex(8 / 2 - 1, 8 / 2 + 1).setPlayerType(PlayerType.WHITE);

    Assert.assertEquals(3, board.countPieces(PlayerType.WHITE));
    Assert.assertEquals(board.getBoardSize(), 8);
  }
   ...
   */
  @Test
  public void testBothPlayersPassedSquare() {

    Player player1 = new Player("e", PlayerType.WHITE, square);
    Player player2 = new Player("s", PlayerType.BLACK, square);
    Assert.assertFalse(player1.hasPassed);
    Assert.assertFalse(player2.hasPassed);
  }
   ...
   */
  @Test
  public void testIsBoardFullWhenBoardIsInitializedSquare() {
    Assert.assertFalse(square.isBoardFull());
  }
